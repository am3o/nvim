...
vim.keymap.set("n", "<leader>rd", ":lua require'dap'.continue()<CR>", { silent = true, desc = "[R]un [D]ebugger" })
vim.keymap.set("n", "<leader>rdt", ":lua require'dap-go'.debug_test()<CR>",
    { silent = true, desc = "[R]un [D]ebugger [T]est" })
vim.keymap.set("n", "<leader>od", ":lua require'dapui'.toggle()<CR>", { silent = true, desc = "[O]pen [D]ebugger" })
